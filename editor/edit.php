    ...
    <div id="divCodeWrapper">
        ...
        <form action="./edit.php" method="POST">
            <textarea id="textarea1" wrap="soft" spellcheck="false" name="data" style = "color:white">
                <?php 
                    echo $data[0]["game_data"];
                ?>
            </textarea>
            <input type="hidden" name="id" value="<?php echo $_GET['id'] ?>">
            <input type="submit" value="Submit data" style="display:block; 
            position:absolute; width: 15%; bottom: 1px; background: red; 
            color: white; font-size: 18px; height: 40px; z-index: 10; right: 50px; top: 500px">
        </form>
