...
export default class Player extends Phaser.Physics.Arcade.Sprite {
  ...
  controlMovimiento() {
    ...
    //Control para saltar
    if (
      (!this.stop && this.btns.up.isDown == true) ||
    ...
    //Animacion de ataque
    if (!this.stop && this.isReadyToAttack() && this.btns.down.isDown == true) {
      this.stop = true;
      this.attacking = true;
    }
