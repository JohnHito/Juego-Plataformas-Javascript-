...
(t = void 0),
  (e = function () {
    const t = Phaser.Input.Keyboard.Key,
      e = Phaser.Input.Keyboard.KeyCodes,
    ...
    class i {
      constructor(t) {
        ...
        for (var e = 0, i = s.length; e < i; e++) {
          var r = s[e];
          this.addKey(r), (this.cursorKeys[r] = this.keys[r]);
        }
      }
      shutdown(t) {
        for (var e in ((this.scene = void 0), this.keys))
          this.keys[e].destroy();
        ...
        return s.enabled
          ? (e && (this.noKeyDown = !1),
            s.isDown !== e &&
              ...
              (r.keyCode = s.keyCode),
              e ? s.onDown(r) : s.onUp(r)),
            this)
          : this;
      }
      clearAllKeysState() {
        for (var t in ((this.noKeyDown = !0), this.keys))
      ...
      addKey(s, i) {
        return (
          void 0 === i && (i = s),
          "string" == typeof i &&
            ((i = i.toUpperCase()), e.hasOwnProperty(i) && (i = e[i])),
          (this.keys[s] = new t(this.scene, i)),
          this
        );
      }
      addKeys(t) {
        for (var e = 0, s = t.length; e < s; e++) this.addKey(t[e]);
        return this;
      }
    }
    var r = {
     ...
     */ const a = Phaser.Utils.Objects.GetValue,
    ...
    class l extends i {
      ...
      resetFromJSON(t) {
        null == this.start && (this.start = { x: 0, y: 0 }),
          null == this.end && (this.end = { x: 0, y: 0 }),
          (this._enable = void 0),
          this.setEnable(a(t, "enable", !0)),
          this.setMode(a(t, "dir", "8dir")),
          this.setDistanceThreshold(a(t, "forceMin", 16));
        var e = a(t, "start.x", null),
          s = a(t, "start.y", null),
          i = a(t, "end.x", null),
          r = a(t, "end.y", null);
        return this.setVector(e, s, i, r), this;
      }
      toJSON() {
        return {
          enable: this.enable,
      ...
      setMode(t) {
        return "string" == typeof t && (t = h[t]), (this.dirMode = t), this;
      }
      get enable() {
        return this._enable;
      }
      ...
      setVector(t, e, s, i) {
        ...
        if (null === t) return this.clearVector(), this;
        if (
          (void 0 === s && ((s = t), (t = 0), (i = e), (e = 0)),
          (this.start.x = t),
          (this.start.y = e),
          (this.end.x = s),
          (this.end.y = i),
        ...
        for (var n in r) this.setKeyState(n, r[n]);
        return this;
      }
      get forceX() {
      ...
      get force() {
        return u(this.start.x, this.start.y, this.end.x, this.end.y);
      }
      get rotation() {
        return d(this.start.x, this.start.y, this.end.x, this.end.y);
      }
      get angle() {
        return this.rotation * n;
      }
      get octant() {
        var t = 0;
        return (
    ...
    var y = {
        ...
        addListener() {
          return (
            this._eventEmitter &&
              this._eventEmitter.addListener.apply(
                this._eventEmitter,
                arguments
              ),
            this
      ...
      c = {};
    const v = Phaser.Utils.Objects.GetValue,
      m = Phaser.Geom.Circle,
      p = Phaser.Geom.Circle.Contains;
    class b extends l {
      constructor(t, e) {
        var s = t.scene;
        super(s, e);
        var i = v(e, "eventEmitter", void 0),
          r = v(e, "EventEmitterClass", void 0);
        this.setEventEmitter(i, r),
          (this.scene = s),
          (this.mainCamera = s.sys.cameras.main),
          (this.pointer = void 0),
          (this.gameObject = t),
          (this.radius = v(e, "radius", 100)),
          t.setInteractive(
            new m(t.displayOriginX, t.displayOriginY, this.radius),
            p
          ),
          this.boot();
      }
      ...
      onKeyDownStart(t) {
        t.isDown &&
          void 0 === this.pointer &&
          ((this.pointer = t), this.onKeyDown(t), this.emit("pointerdown", t));
      }
      onKeyDown(t) {
        if (this.pointer === t) {
          var e = (function (t, e, s) {
            ...
            return i
              ? (void 0 === s ? (s = {}) : !0 === s && (s = c),
                i === e
                  ? ((s.x = t.worldX), (s.y = t.worldY))
                  : i.getWorldPoint(t.x, t.y, s),
                s)
              : null;
          })(t, this.mainCamera, !0);
          if (e) {
            var s = t.camera,
              i = this.gameObject,
              r = i.x - s.scrollX * (i.scrollFactorX - 1),
              n = i.y - s.scrollY * (i.scrollFactorY - 1);
            this.setVector(r, n, e.x, e.y),
              (this.end.x = e.x),
              (this.end.y = e.y),
              this.emit("update");
          }
      ...
      forceUpdate() {
        var t = this.pointer;
        return t && t.isDown ? (this.onKeyDown(t), this) : this;
      }
    }
    Object.assign(b.prototype, y);
    const g = Phaser.Utils.Objects.GetValue;
    class f {
      constructor(t, e) {
        void 0 === e && (e = {});
        var s = g(e, "eventEmitter", void 0),
          i = g(e, "EventEmitterClass", void 0);
        this.setEventEmitter(s, i),
          (e.eventEmitter = this.getEventEmitter()),
          (this.scene = t),
          (this.base = void 0),
          (this.thumb = void 0),
          (this.touchCursor = void 0),
          this.setRadius(g(e, "radius", 100)),
          this.addBase(g(e, "base", void 0), e),
          this.addThumb(g(e, "thumb", void 0));
        var r = g(e, "x", 0),
          n = g(e, "y", 0);
        this.base.setPosition(r, n),
          this.thumb.setPosition(r, n),
          g(e, "fixed", !0) && this.setScrollFactor(0),
          this.boot();
      }
      destroy() {
        this.destroyEventEmitter(),
      ...
      setPosition(t, e) {
        return (
          (this.x === t && this.y === e) ||
            ((this.x = t), (this.y = e), this.forceUpdateThumb()),
          this
        );
      }
      set x(t) {
      ...
      setScrollFactor(t) {
        return (
          this.base.setScrollFactor(t), this.thumb.setScrollFactor(t), this
        );
      }
      boot() {
      ...
      update() {
        var t,
          ...
          i = s.dirMode;
        if (s.anyKeyDown)
          if (s.force > this.radius) {
            var r = s.rotation;
            (t = 0 !== i ? Math.cos(r) * this.radius : 0),
              (e = 1 !== i ? Math.sin(r) * this.radius : 0);
          } else (t = 0 !== i ? s.forceX : 0), (e = 1 !== i ? s.forceY : 0);
        else (t = 0), (e = 0);
        return (
          (this.thumb.x = this.base.x + t),
          (this.thumb.y = this.base.y + e),
          this
        );
      }
      forceUpdateThumb() {
    ...
    Object.assign(f.prototype, y);
    class E extends Phaser.Plugins.BasePlugin {
      constructor(t) {
        super(t);
      }
      start() {
      ...
      addVectorToCursorKeys(t) {
        return new l(void 0, t);
      }
    }
    return E;
  }),
