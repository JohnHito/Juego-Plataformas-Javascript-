export default class DeadScene extends Phaser.Scene {
  constructor() {
    super({ key: "DeadScene", active: false });
  ...
  create() {
    this.pauseGame();
    this.add.image(440, 140, "gameover").setInteractive().setScale(0.18);
    // Add a blue rectangle button with text "Resume"
    const mainButton = this.createBtn(440, 300, 200, 50, "Main Menu", 0x34adff, 0.5);
